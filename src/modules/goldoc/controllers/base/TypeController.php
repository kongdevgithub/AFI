...
use app\modules\goldoc\models\search\TypeSearch;
...
class TypeController extends Controller
{
	...
	public function actionCreate() {
		...
		if ($model->load(Yii::$app->request->post()) && $model->save()) {
			Yii::$app->getSession()->addFlash('success', Yii::t('goldoc', 'Type has been created.'));
	...
	public function actionUpdate($id) {
		...
		if ($model->load(Yii::$app->request->post()) && $model->save()) {
			Yii::$app->getSession()->addFlash('success', Yii::t('goldoc', 'Type has been updated.'));
			return $this->redirect(ReturnUrl::getUrl(['view', 'id' => $model->id]));
		} elseif (!Yii::$app->request->isPost) {
			$model->load(Yii::$app->request->get());
		}
	...
	public function actionCopy($id) {
		...
		if ($model->load(Yii::$app->request->post()) && $model->save()) {
			...
			$model->load(['Type' => $modelCopy->attributes]);
		}
	...
	public function actionDelete($id) {
		...
		$model->delete();
		Yii::$app->getSession()->addFlash('success', Yii::t('goldoc', 'Type has been deleted.'));
