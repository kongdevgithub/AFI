...
/**
 * SubstrateSearch represents the model behind the search form about `app\modules\goldoc\models\Substrate`.
 */
class SubstrateSearch extends Substrate
{
