...
$columns[] = [
    ...
    'value' => function ($model) {
        /** @var Venue $model */
        return Yii::$app->user->can('goldoc_venue_view') ? Html::a($model->code, ['view', 'id' => $model->id]) : $model->id;
    },
    'format' => 'raw',
    'headerOptions' => [
        'style' => 'width:80px;',
...
//    'data-toggle' => 'modal',
//    'data-target' => '#venue-searchModal',
//]);
if (Yii::$app->user->can('goldoc_venue_create', ['route' => true])) {
