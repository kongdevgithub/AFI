...
if (Yii::$app->user->can('goldoc_product_update', ['route' => true])) {
    $items[] = [
...
if (Yii::$app->user->can('goldoc_product_copy', ['route' => true])) {
    $items[] = [
...
if (Yii::$app->user->can('goldoc_product_trail', ['route' => true])) {
    $items[] = [
        'label' => '<i class="fa fa-database"></i> ' . Yii::t('goldoc', 'Trail'),
        'url' => ['trail', 'id' => $model->id, 'ru' => ReturnUrl::getToken()],
        'encode' => false,
        'active' => Yii::$app->controller->action->id == 'trail'
    ];
}
if (Yii::$app->user->can('goldoc_product_delete', ['route' => true])) {
    $items[] = [
