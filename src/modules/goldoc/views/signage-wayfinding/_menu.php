...
//if (Yii::$app->user->can('app_signage-wayfinding_update', ['route' => true])) {
//	$items[] = [
...
//	];
//}
//if (Yii::$app->user->can('app_signage-wayfinding_copy', ['route' => true])) {
//	$items[] = [
...
//	];
//}
//if (Yii::$app->user->can('app_signage-wayfinding_delete', ['route' => true])) {
//	$items[] = [
