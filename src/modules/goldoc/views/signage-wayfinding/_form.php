...
<div class="signage-wayfinding-form">

    <?php $form = ActiveForm::begin([
		'id' => 'SignageWayfinding',
    ...
    <?php echo $form->field($model, 'message_side_1')->textarea(['rows' => 6]) ?>

    <?php echo $form->field($model, 'message_side_2')->textarea(['rows' => 6]) ?>

    <?php echo $form->field($model, 'batch')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'sign_id')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'sign_code')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'level')->textInput(['maxlength' => true]) ?>
