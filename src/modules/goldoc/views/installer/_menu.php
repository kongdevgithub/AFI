...
if (Yii::$app->user->can('app_installer_update', ['route' => true])) {
    $items[] = [
...
if (Yii::$app->user->can('app_installer_copy', ['route' => true])) {
    $items[] = [
...
if (Yii::$app->user->can('app_installer_delete', ['route' => true])) {
    $items[] = [
