 ...
 * @var app\modules\goldoc\models\search\SportSearch $searchModel
 */
$columns = [];
$columns[] = [
    'attribute' => 'code',
    'value' => function ($model) {
        /** @var Sport $model */
        return Yii::$app->user->can('goldoc_sport_view') ? Html::a($model->code, ['view', 'id' => $model->id]) : $model->id;
    },
    'format' => 'raw',
    'headerOptions' => [
        'style' => 'width:80px;',
...
//    'data-toggle' => 'modal',
//    'data-target' => '#sport-searchModal',
//]);
if (Yii::$app->user->can('goldoc_sport_create', ['route' => true])) {
