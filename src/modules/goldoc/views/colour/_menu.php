...
if (Yii::$app->user->can('goldoc_colour_update', ['route' => true])) {
	$items[] = [
...
if (Yii::$app->user->can('goldoc_colour_copy', ['route' => true])) {
	$items[] = [
...
if (Yii::$app->user->can('goldoc_colour_delete', ['route' => true])) {
	$items[] = [
