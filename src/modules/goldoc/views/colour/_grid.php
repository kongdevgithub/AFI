...
$columns[] = [
    ...
    'value' => function ($model) {
        /** @var Colour $model */
        return Yii::$app->user->can('goldoc_colour_view', ['route' => true]) ? Html::a($model->code, ['view', 'id' => $model->id]) : $model->code;
    },
    'format' => 'raw',
];
$columns[] = 'name';
...
$gridActions[] = Html::button('<i class="fa fa-search"></i> ' . Yii::t('goldoc', 'Search'), [
    ...
    'data-toggle' => 'modal',
    'data-target' => '#colour-searchModal',
]);
if (Yii::$app->user->can('goldoc_colour_create', ['route' => true])) {
