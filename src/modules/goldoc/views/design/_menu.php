...
if (Yii::$app->user->can('goldoc_design_update', ['route' => true])) {
	$items[] = [
...
if (Yii::$app->user->can('goldoc_design_copy', ['route' => true])) {
	$items[] = [
...
if (Yii::$app->user->can('goldoc_design_delete', ['route' => true])) {
	$items[] = [
