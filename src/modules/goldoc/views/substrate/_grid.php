...
$columns[] = [
    ...
    'value' => function ($model) {
        /** @var Substrate $model */
        return Yii::$app->user->can('goldoc_substrate_view', ['route' => true]) ? Html::a($model->code, ['view', 'id' => $model->id]) : $model->code;
    },
    'format' => 'raw',
];
$columns[] = 'name';
...
$gridActions[] = Html::button('<i class="fa fa-search"></i> ' . Yii::t('goldoc', 'Search'), [
    ...
    'data-toggle' => 'modal',
    'data-target' => '#substrate-searchModal',
]);
if (Yii::$app->user->can('goldoc_substrate_create', ['route' => true])) {
...
echo GridView::widget([
    ...
    'panel' => [
        'heading' => Yii::t('goldoc', 'Substrates'),
    ],
]);
