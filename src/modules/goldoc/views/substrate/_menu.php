...
if (Yii::$app->user->can('goldoc_substrate_update', ['route' => true])) {
	$items[] = [
...
if (Yii::$app->user->can('goldoc_substrate_copy', ['route' => true])) {
	$items[] = [
...
if (Yii::$app->user->can('goldoc_substrate_delete', ['route' => true])) {
	$items[] = [
