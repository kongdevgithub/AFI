...
use app\models\search\ItemTypeSearch;
...
/**
 * This is the class for controller "app\controllers\ItemTypeController".
 */
class ItemTypeController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->addFlash('success', Yii::t('app', 'Item Type has been created.'));
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->addFlash('success', Yii::t('app', 'Item Type has been updated.'));
            return $this->redirect(ReturnUrl::getUrl(['view', 'id' => $model->id]));
        } elseif (!\Yii::$app->request->isPost) {
            $model->load(Yii::$app->request->get());
        }
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->getSession()->addFlash('success', Yii::t('app', 'Item Type has been deleted.'));
