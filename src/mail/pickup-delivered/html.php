...
// TODO - Dean to provide image
//$this->params['headerImage'] = Yii::$app->params['s3BucketUrl'] . '/img/mail/afi/pickup-delivered-header.jpg';
...
foreach ($pickups as $pickupInfo) {
    ...
    $row = '<h3>pickup-' . $pickup->id . ' has been delivered.</h3>';
    $carrier = [];
    if ($pickup->carrier) {
