...
if ($model->status != 'complete') {
    echo Alert::widget([
        'body' => Html::a('<i class="fa fa-refresh" title="' . Yii::t('app', 'Reload') . '"></i>', ['export/view', 'id' => $model->id]) . '&nbsp;&nbsp;' . Yii::t('app', 'Export is being generated') . '<small>[status=' . $model->status . '|gearman_process=' . $model->gearman_process . ']</small>',
