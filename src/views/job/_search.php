    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                echo $form->field($model, 'quote_at');
                echo $form->field($model, 'production_at');
                echo $form->field($model, 'despatch_at');
                echo $form->field($model, 'packed_at');
                echo $form->field($model, 'complete_at');
                echo $form->field($model, 'production_date');
                echo $form->field($model, 'despatch_date');
                ...
                echo $form->field($model, 'invoice_sent');
