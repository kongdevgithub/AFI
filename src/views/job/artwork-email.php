 ...
 * @var app\models\form\JobArtworkEmailForm $model
 * @var ActiveForm $form
 */
...
//$this->params['breadcrumbs'][] = Yii::t('app', 'Artwork Email');

$ru = isset($ru) ? $ru : ReturnUrl::getRequestToken();
?>

<div class="job-artwork-email">
    <?php
    $form = ActiveForm::begin([
        'id' => 'Job',
        'formConfig' => ['labelSpan' => 0],
        'enableClientValidation' => false,
        'action' => ['artwork-email', 'id' => $model->job->id],
    ...
    echo $this->render('/job/_artwork-email-details', ['model' => $model->job]);
    echo $form->field($model->job, 'artwork_email_text')->widget(TinyMce::className(), [
        'options' => ['rows' => 8],
        'clientOptions' => [
            'menubar' => false,
