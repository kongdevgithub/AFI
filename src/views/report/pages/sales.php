...
<div class="report-rep-performance">
    ...
    <div class="box box-default collapsed-box">
        ...
        <div class="box-body">
            <?php
            echo Alert::widget([
                'body' => Yii::t('app', 'This report is based on Job.due_at.'),
    ...
    echo $this->render('_paginate_periods', [
        ...
        'from' => $from,
        'to' => $to,
        'url' => ['/report/index', 'report' => 'sales', 'period' => $period],
    ]);
    ...
    foreach ($jobs as $k => $job) {
        if (in_array($job->status, ['job/draft', 'job/quote', 'job/suspended', 'job/cancelled'])) unset($jobs[$k]);
    ...
    <table class="table table-condensed table-bordered">
        ...
        <tr>
            ...
            <th width="30%" class="text-center"><?= Yii::t('app', 'Jobs') ?></th>
                ...
                <table class="table table-condensed table-bordered">
                    ...
                    foreach ($jobs as $_job) {
                        ...
                        if (in_array($quote_time, ['7 days', '14 days', '30 days'])) {
                            $quote_time = 'new company jobs';
                        } else {
                            $quote_time = 'existing company jobs';
                        }
