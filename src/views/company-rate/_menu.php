...
if (Yii::$app->user->can('app_company-rate_update', ['route' => true])) {
	$items[] = [
...
//if (Yii::$app->user->can('app_company-rate_copy', ['route' => true])) {
//	$items[] = [
...
//	];
//}
if (Yii::$app->user->can('app_company-rate_delete', ['route' => true])) {
	$items[] = [
